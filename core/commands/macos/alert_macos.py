...
class command:
    ...
    def run(self,session,cmd_data):
        ...
        icon = input(h.WW+"[>]"+h.WHITE+" Alert Icon: "+h.ENDC)
        application = input(h.WW+"[>]"+h.WHITE+" Alert Application: "+h.ENDC)
        fbutton = input(h.WW+"[>]"+h.WHITE+" First Button: "+h.ENDC)
        sbutton = input(h.WW+"[>]"+h.WHITE+" Second Button: "+h.ENDC)
        one = '"'
        payload = """
