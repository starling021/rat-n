...
# About Mouse Framework
    ...
    that gives you a command line session with extra functionality between you and 
    a target machine with simple Mouse payload. Mouse gives you the power and convenience 
